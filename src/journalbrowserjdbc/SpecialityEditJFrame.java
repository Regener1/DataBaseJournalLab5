 ...
 * @author Regener
 */
public class SpecialityEditJFrame extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try {
            ...
            entity.setId_faculty(Long.parseLong(values[2]));
            
            service.add(entity);
            showAllInfo();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(rootPane, ex.getMessage());
            Logger.getLogger(SpecialityEditJFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpecialityEditJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SpecialityEditJFrame().setVisible(true);
            }
        });
    }
    ...
    private void updateComboBoxes(){
        try {
            ...
            List<Speciality> entities = service.all();
            for(Speciality e : entities){
