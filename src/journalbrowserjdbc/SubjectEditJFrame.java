 ...
 * @author Regener
 */
public class SubjectEditJFrame extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try {
            ...
            entity.setAbbreviation(values[1]);
            entity.setHours_of_lecture(Integer.parseInt(values[2]));
            entity.setHours_of_practice(Integer.parseInt(values[3]));
            service.add(entity);
            showAllInfo();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(rootPane, ex.getMessage());
            Logger.getLogger(SubjectEditJFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubjectEditJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SubjectEditJFrame().setVisible(true);
            }
        });
    }
...
private void updateComboBoxes(){
        try {
            ...
            List<Subject> entities = service.all();
            for(Subject e : entities){
