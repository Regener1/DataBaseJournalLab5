 ...
 * @author Regener
 */
public class AssessmentEditJFrame extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try {
            ...
            java.util.Date dat_utl = format.parse(values[0]);
            entity.setDate_assessment(new java.sql.Date(dat_utl.getTime()));

            entity.setField_assessment(values[1]);
            entity.setId_student(Long.parseLong(values[2]));
            entity.setId_subject(Long.parseLong(values[3]));
            entity.setId_teacher(Long.parseLong(values[4]));
            entity.setId_test_type(Long.parseLong(values[5]));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssessmentEditJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AssessmentEditJFrame().setVisible(true);
            }
        });
    }
    ...
    private void updateComboBoxes(){
        try {
            ...
            List<Assessment> entities = service.all();
            for(Assessment e : entities){
